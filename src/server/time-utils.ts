...
function lastSundayOfMonth(year: number, month0: number, utcHour: number) {
 ...
 */
function getTallinnOffsetHours(date: Date) {
...
export function getSecondsOfDayInTallinn(date: Date) {
